...
def animate(i, xs, ys):
  ...
  #  rs.append(0.5)
    ...
    # Draw x and y lists
    ax.clear()
    ax.plot(xs, label="Experimental Probability")
  #  ax.plot(xs, rs, label="Theoretical Probability")
    ...
    plt.legend()
    plt.axis([1, None, 0, 10]) #Use for arbitrary number of trials
    #plt.axis([1, 100, 0, 1.1]) #Use for 100 trial demo

# Set up plot to call animate() function periodically
ani = animation.FuncAnimation(fig, animate, fargs=(chan1, chan2), interval=10)
plt.show()